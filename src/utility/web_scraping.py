"""
Functions used from the GitHub GPT Researcher Project.

Permalink to the source file which contains the original code:
https://github.com/assafelovic/gpt-researcher/blob/fa13d5f0be0c1917335a24d820af6f0492f19151/gpt_researcher/scraper/scraper.py
"""
...
class Scraper:
    ...
    def extract_data_from_link(self, link, session) -> dict[str, str]:
        """
        ...
        try:
            ...
            # limit content size to fit into llm
    ...
    def get_content_from_url(self, soup) -> str:
